...
func (ec *executionContext) _Course_category(ctx context.Context, field graphql.CollectedField, obj *model.Course) (ret graphql.Marshaler) {
	...
	fc.Result = res
	return ec.marshalNCateogry2ᚖgithubᚗcomᚋdevfullcycleᚋ13ᚑGRAPHQLᚋgraphᚋmodelᚐCateogry(ctx, field.Selections, res)
}
...
func (ec *executionContext) _Query_categories(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	res := resTmp.([]*model.Cateogry)
	fc.Result = res
	return ec.marshalNCateogry2ᚕᚖgithubᚗcomᚋdevfullcycleᚋ13ᚑGRAPHQLᚋgraphᚋmodelᚐCateogryᚄ(ctx, field.Selections, res)
}
...
func (ec *executionContext) unmarshalInputNewCourse(ctx context.Context, obj interface{}) (model.NewCourse, error) {
	...
	fieldsInOrder := [...]string{"name", "description", "caregoryId"}
	for _, k := range fieldsInOrder {
		v, ok := asMap[k]
		if !ok {
			continue
		...
		case "caregoryId":
			...
			ctx := graphql.WithPathContext(ctx, graphql.NewPathWithField("caregoryId"))
...
func (ec *executionContext) marshalNCateogry2githubᚗcomᚋdevfullcycleᚋ13ᚑGRAPHQLᚋgraphᚋmodelᚐCateogry(ctx context.Context, sel ast.SelectionSet, v model.Cateogry) graphql.Marshaler {
	return ec._Cateogry(ctx, sel, &v)
}

func (ec *executionContext) marshalNCateogry2ᚕᚖgithubᚗcomᚋdevfullcycleᚋ13ᚑGRAPHQLᚋgraphᚋmodelᚐCateogryᚄ(ctx context.Context, sel ast.SelectionSet, v []*model.Cateogry) graphql.Marshaler {
	...
	for i := range v {
		...
		f := func(i int) {
			...
			ret[i] = ec.marshalNCateogry2ᚖgithubᚗcomᚋdevfullcycleᚋ13ᚑGRAPHQLᚋgraphᚋmodelᚐCateogry(ctx, sel, v[i])
		}
		if isLen1 {
			f(i)
		} else {
...
func (ec *executionContext) marshalNCateogry2ᚖgithubᚗcomᚋdevfullcycleᚋ13ᚑGRAPHQLᚋgraphᚋmodelᚐCateogry(ctx context.Context, sel ast.SelectionSet, v *model.Cateogry) graphql.Marshaler {
	if v == nil {
		if !graphql.HasFieldError(ctx, graphql.GetFieldContext(ctx)) {
			ec.Errorf(ctx, "the requested element is null which the schema does not allow")
		}
